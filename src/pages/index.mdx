...
By following our [tutorials](tutorials/starter/time), you will be guided through the steps of deploying Toit apps on your hardware and how to use external sensors with Toit.
