...
[automatic block argument, `it`](/language/blocks/#block_arguments).
...
[block](blocks.md) with [two named
arguments](/language/blocks/#block_arguments)).
...
[continue.map](/language/blocks/#local_return)
