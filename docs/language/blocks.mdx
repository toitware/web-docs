...
<div class="toit">
  ``` main: // Print the numbers from 1 to 10, one per line. 10.repeat: print it + 1 // Print the elements in the list,
  one per line. ["what", "a", "list"].do: print it ```
</div>
...
<div class="toit">``` repeat [block]: // ... ```</div>
...
<div class="toit">``` main: 4.repeat: print "again" ```</div>
...
<div class="toit">``` main: ["Siri", "John", "Sue"].do: print it ```</div>
...
<div class="toit">``` main: ["Siri", "John", "Sue"].do: | name | print name ```</div>
...
<div class="toit">``` main: print "multi" print "line" ```</div>
...
<div class="toit">``` main: block_variable := : print it + 1 10.repeat block_variable ```</div>
