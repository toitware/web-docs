...
The developer creates a fresh Git repository with these files and adds a file specification file `package.yaml`. This file serves as a signal to TPM that the repository can be used as a package.
