...
- **Constants** are a special case of globals, defined with a `::=` assignment. By convention they have an ALL_CAPS_NAME (see [Toit globals and constants](../syntax#toit-globals-and-constants)).
