...
Some of these require the import of the [fixed_point library](https://libs.toit.io/lib/fixed_point.toit).
...
[escape syntax](/language/strings/#escaped_characters).

Null is [converted to boolean](/language/booleans/)
