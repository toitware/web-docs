...
At the end of the provisioning process, you should receive the name of the device, and a URL to see it in the Toit console. If there were errors, see
the troubleshooting section in the [provision](../connect/provision) page.
