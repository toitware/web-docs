...
This guide takes you from signing up for a Toit account, to install the Toit CLI locally and prepare your [ESP32](https://www.espressif.com/en/products/socs/esp32) microcontroller with the Toit firmware, 
