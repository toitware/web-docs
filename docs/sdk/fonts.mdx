...
Note that the Toit font display code does not support composable accents, and
...
See the [copyright message](licenses/adobe_copyright.md).
...
mainly Latin letters, including accented variants.
See the [copyright message](licenses/bigelow_and_holmes_copyright.md).
...
See the [copyright message](licenses/nmsu_copyright.md)
...
See the [copyright message](licenses/matthew_welch_copyright.md).
...
See the [copyright message](licenses/apache_font_license.md).
