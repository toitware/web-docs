...
The Toit SDK [pixel_display module](https://libs.toit.io/lib/pixel_display.toit) includes support for writing text and printing icons on displays.
We highlight in this section the basic functions of display use. You can also learn more about the different fonts available in the SDK by reading [Toit font basics](fonts.md).
...
Learn more about all available fonts [here](fonts.md).
