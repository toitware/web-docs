...
Multiline comments are the preferred documentation for longer comments. The individual lines should *not* have any leading `*`, and should be aligned with the first `/`.
