...
## Fork
Start by forking the [envelope](https://github.com/toitlang/envelopes)
...
clear the cache, located at `~/.cache/artemis/envelopes/github.com`, so that
Artemis downloads the updated envelope.
