...
in [the IDE tutorial](/tutorials/setup/ide).

We also assume that you have flashed your device with Jaguar and that
you are familiar with running Toit programs on it.
If not, have a look at the [Hello world](/tutorials/setup/firstprogram) tutorial.
...
imported as a package. See the [packages](/tutorials/setup/packages)
