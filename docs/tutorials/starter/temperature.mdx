...
Follow the steps [here](../../../drivers/sensors/bme280/) to connect the BME280 sensor with your ESP32.
...
We also need to specify the [GPIO pins](../../../drivers/sensors/gpio) and the relevant [connection bus](../../../drivers/sensors/protocols).
