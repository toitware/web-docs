...
a look at the [Fading LED tutorial](/tutorials/hardware/pwm-led) first.
...
Similarly to the [fading LED example](/tutorials/hardware/pwm-led) we just need to create a
