...
import Espressif from "../_images/espressif.png";
...
<Box title="ESP-NOW" to="network/espnow">
<NonZoomableImage
  src={Espressif}
  width="70%"
  alt="Espressif Logo."
...
Use ESP-NOW to communicate between ESP32 devices.
</Box>
</Boxes>
...
<Box title="MQTT with Qubitro"to ="mqtt/qubitro">
<NonZoomableImage
  src={Qubitro}
  alt="Qubitro logo."
  width="45%"
...
Use Qubitro as your MQTT broker through Toit [services](/tutorials/containers/services).
</Box>
...
## Envelopes
Build your own envelope with custom firmware configurations or
C services.

<Boxes>

<Box title="Customized envelope" to="misc/custom-envelope">
<NonZoomableImage
  src={ToitLogo}
  alt="Toit logo."
  width="60%"
...
<Box title="Customized local envelope" to="misc/custom-envelope-local">
<NonZoomableImage
  src={ToitLogo}
  alt="Toit logo."
  width="60%"
...
<Box title="Communicate with a C service" to="misc/c-service">
<NonZoomableImage
  src={CLogo}
  alt="C logo."
  width="60%"
...
<Box title="Over the air updates" to="misc/ota">
<NonZoomableImage
  src={Ota}
  alt="A picture of a cloud and Toit logos raining onto a chip."
  width="40%"
/>
