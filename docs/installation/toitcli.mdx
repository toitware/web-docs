...
Mac users may get the following warning when starting Toit for the first time. Click on the **?** and follow the instructions to **Allow anyway** the toit executable
