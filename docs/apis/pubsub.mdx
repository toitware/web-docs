...
PubSub can be used both on devices through the <a href="https://docs.toit.io/toitdocs/latest/lib_pubsub.html" target="_blank">PubSub library</a> and external systems using the <a href="https://github.com/toitware/api/tree/master/proto/toit/api/pubsub" target="_blank">PubSub GRPC API</a>.
...
See some examples of PubSub communication between apps in the <Link to="../tutorials/pubsubint">pubsub tutorial</Link>.
