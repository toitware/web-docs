...
See some examples of PubSub communication between apps in the [Tutorials](../../platform/tutorials/pubsub/pubsubint) section.
...
Go to the [PubSub](https://console.toit.io/pubsub) page and click on **Create Subscription**. The topic `cloud:topic-name` is the one defined in the Publisher Toit program.
You can provide a name of the subscription, in order to give a description of the topic or in which scenario it is used.
