...
The General Purpose Input/Output (GPIO) pins is the basic unit working with peripherals. In Toit, they can easily be configured and manipulated at runtime.

The GPIO pins are exposed in the [gpio.toit module](https://libs.toit.io/gpio/library-summary).
...
## Adding sensors with Qwiic cables
