...
From the [Web Serial](https://console.toit.io/serial) view in the Toit console, you can either provision or reinstall the ESP32 with the Toit firmware and provide initial WiFi connection settings
...
about device configuration for more information of how to add additional WiFi connnections to a given device.
