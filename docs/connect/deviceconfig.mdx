...
import WifiNbiotConnections from "../_images/wifinbiotconnections.png";
...
The current firmware version installed on the device is displayed in the Firmware section. Click on the Edit icon to change it to another version from the drop down menu, then click Save. 
The proposed change is displayed both in the Firmware section and with an icon near the name of the device until it is actually installed the next time the device comes online.
...
<img src={WifiNbiotConnections} alt="Screenshot of changing the Wifi connection in the Toit console" />
