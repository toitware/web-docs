...
- The firmware version on the device is the one installed during initial [device provisioning](../provision).
...
See how you can minimize data storage and frequent triggered online connection in the [Devices management](../../console/deviceconsole) section.
