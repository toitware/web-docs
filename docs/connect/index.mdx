...
Your hardware must be initially provisioned and claimed into your organization in the Toit console, before you can start interacting with your hardware.
...
If your hardware can get online using the WiFi credentials given in the provision command, the hardware will automatically be claimed into your organization in the Toit console during the provisioning process. 

This means that your hardware will afterwards be available in the Toit console, ready for you to deploy Toit apps on it and monitor logs, metrics and application data from the hardware.
