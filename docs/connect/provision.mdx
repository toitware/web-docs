...
# Provision and claim your hardware

The provision command will create a new hardware identity. If your hardware can get online, the provision command will also claim your hardware into your organization automatically.
