...
The provision command will create a new hardware identity. Use the provision command only once per hardware. 

As a start, you can provision up to 10 new hardware IDs with the free version of Toit, and later, if you have many hardware devices, you can request for more hardware IDs in the [Toit console](https://console.toit.io/organization/details).
