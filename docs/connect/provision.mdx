...
If you have trouble connecting your ESP32 via a serial port to your computer, or problems with flashing the ESP32, please visit the [troubleshooting](../serialport) section.
