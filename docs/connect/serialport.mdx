...
If you are using macOS or Windows, you might need to install or update 
...
Install both drivers, reboot your computer and try running the serial commands again in the Toit CLI.
