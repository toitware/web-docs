...
# WiFi credentials troubleshoot

## Problems with WiFi connection

<details>
  <summary>Do you have problems getting your ESP32 online with WiFi?</summary>
...
- If you are using an open WiFi with no password, use the Toit CLI when reinstalling or provisioning your ESP32 in order to provide an empty string as the password to the command.
...
<details>
  <summary>Do you have an unreachable device?</summary>
