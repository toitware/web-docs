...
The overall status section accumulates devices based on their health issues - or lack thereof. Note that a device can be counted in more than one category, except for devices in the "No issues category" that is exclusive of all others.
