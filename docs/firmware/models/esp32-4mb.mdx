...
This model support ESP32s with at least 4MB of flash.

## Supported models

Today ESP32s come in multiple flavors. This model supports the *classical* ESP32s chips running a dual-core on the Xtensa LX6 architecture:
...
And most likely any other modules with the above mentioned chips, with a minimum of 4 MB flash.
