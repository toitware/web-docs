...
Today, ESP32s come in multiple flavors. Toit supports the _classical_ ESP32 chips running a dual-core on the Xtensa LX6 architecture:
...
- ESP32-S2 _(Single-core / Xtensa LX7)_
- ESP32-C3 _(Single-core / RISC-V)_
- ESP32-S3 _(Xtensa LX7)_
- ESP32-C6 _(Single-core / RISC-V)_

## Model parameters

The Toit model, called `esp32-4mb`, supports a number of model-specific parameters to control core peripherals.
