...
can access it from your project.
...
```shell
toit serial port use my-port
```

and replace `my-port` with the actual port name.
...
The provision commands automatically claims the device into your project,
