...
Replace `mySSID` and `myPassword` with your own WiFi credentials in the following command:
...
```shell
toit serial provision -m <model> -p wifi.ssid="mySSID" -p wifi.password="myPassword"
```
