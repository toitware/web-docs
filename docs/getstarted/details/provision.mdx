...
as descripbed in the [Quick Start](../quick_start_guide) guide.
...
If you haven't installed Toit on your computer yet, follow the steps described [here](../../installation/toitcli).
