...
- try updating your drivers. If you are on Windows or macOS make sure your USB drivers are up to date.
...
- try to plug in the hardware with a USB cable directly into your computer instead of using a USB dongle in between.
