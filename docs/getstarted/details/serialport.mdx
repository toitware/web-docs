...
- if you try via the Toit CLI, remember to close the browser window if you have tried to create a serial connection in the browser via https://console.toit.io/serial first.
