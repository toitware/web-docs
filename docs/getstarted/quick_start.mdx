...
Go to the Serial menu in the [Toit console](https://console.toit.io/serial) to initially provision your hardware.

A detailed description of using Web Serial can be found [here](../details/webserial).

Note that the Web Serial in the Toit console only works in Google Chrome and Microsoft Edge browsers.
