...
Replace `mySSID` and `myPassword` with your own WiFi credentials and run the Toit CLI command:

```txt
toit serial provision -p wifi.ssid="mySSID" -p wifi.password="myPassword"
```
