...
import YoutubeMac from "../../_images/youtube-macos.png";
...
[<img src={YoutubeMac} alt="Watch the YouTube video" width="300" />](https://www.youtube.com/watch?v=uGQPGNEH_sU&ab_channel=Toit)
