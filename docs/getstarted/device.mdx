...
It uses the open-source Jaguar service to enable live reloading when developing for the ESP32 and you
...
Jaguar is fast enough that it is possible to ask Jaguar to keep watching your Toit code
...
After this the program will be rerun every time the device reboots. You can also list the currently installed
