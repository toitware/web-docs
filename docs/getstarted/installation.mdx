...
You can choose to install Visual Studio Code, if you want to use the Toit Language Extension for Visual Studio Code that helps you write Toit programs.
...
and we have an independent syntax file [for VIM users](https://github.com/toitware/ide-tools/tree/master/vim).
