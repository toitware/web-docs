...
The public code of a package should have toitdocs. See the [documentation convention](https://docs.toit.io/language/toitdoc/) for Toit, to learn how to write good inline documentation.
