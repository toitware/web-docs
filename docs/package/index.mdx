...
The public code of a package should have toitdocs. See the [documentation convention](../../sdk/toitdoc) for Toit, to learn how to write good inline documentation.
