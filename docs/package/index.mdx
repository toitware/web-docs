...
The public code of a package should have toitdocs. See the [language documentation conventions](https://docs.toit.io/language/toitdoc/), to learn how to write good inline documentation.
