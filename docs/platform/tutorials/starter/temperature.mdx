...
Follow the steps [here](../../../../peripherals/drivers/bme280/) to connect the BME280 sensor with your ESP32.

## Run on an ESP32

To get data from the sensors, we make use of the [bme280 sensor driver](https://libs.toit.io/drivers/bme280/library-summary) by importing it in the Toit program with `import drivers.bme280`.
...
tab** of the device to see the logged temperature, humidity
