...
A BLE device is able to connect to a remote device. The result of initiating a connection is a client. The client can then be used to navigate the
...
main:
  ...
  // The battery level is a single-byte attribute, between 0 and 100.
