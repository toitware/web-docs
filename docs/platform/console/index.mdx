...
The Data page allows to create PubSub, Logs, and System metrics subscriptions. Existing subscription are listed on the page and can be deleted with the bin icon.
