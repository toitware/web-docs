...
The **Search** field allows to search for devices by name, ID, or firmware versions.
...
This pages let's you communicate with your hardware via the Web Serial API. The serial communication is only for initial hardware provisioning or serial debugging.
