...
A warning sign next to the firmware version means that the installed firmware does no longer have a corresponding version available in the Toit cloud. 
...
The fleet health page collects the device status for all devices in your organization.
