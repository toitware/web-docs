...
- **Deploying applications**
  ...
  where a scheduled execution of your code file is controlled by a separate scheduling file. These two files together form an app that can be deployed, or installed, onto
  your device. Learn how to install your Toit app [here](./installingapp).


To get the best development experience we recommend you to use Visual Studio Code along with our Toit extension. You can download Visual Studio Code [here](https://code.visualstudio.com/Download).