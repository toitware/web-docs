...
- **Deploying applications**
  ...
  where a scheduled execution of your program is controlled by a separate scheduling file. These two files together form an app that can be deployed onto
  your device. Learn how to install your Toit app [here](./installingapp).

To get the best development experience we recommend you to use Visual Studio Code with the Toit extension. You can download Visual Studio Code [here](https://code.visualstudio.com/Download).
