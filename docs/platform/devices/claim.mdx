...
Connect the ESP32 to a computer with a USB cable.
...
Manually claim the ESP32 into your Toit project by navigating to the [Toit console](https://console.toit.io/devices) and click the "Add device" button in the upper right corner.
Choose "Claim existing" in the view. Enter the hardware ID of the ESP32.
...
The device can now be viewed in the [list of devices](https://console.toit.io/devices).
