...
Your device will be automatically claimed into your Toit project, both when provisioning a device using our [Web Serial interface](https://console.toit.io/serial) and the [CLI](/platform/cli/#provisioning). 
