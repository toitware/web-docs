...
You can use the `Monitor` button in the [serial page](https://console.toit.io/serial) to verify whether the ESP32 tries to connect to the Toit console via WiFi.
...
2. Copy the hardware ID of the ESP32 to be claimed.

3. Navigate to the [Toit console](https://console.toit.io/devices) and click the "Add device" button in the upper right corner. Choose "Claim existing" in the view. Enter the hardware ID of the ESP32.
...
5. The device has now been claimed into your Toit project, and can be viewed in the devices list from the [Toit console](https://console.toit.io/devices).
