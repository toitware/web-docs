...
In addition to this, there are some other concepts that are crucial to understand when working with Toit. 
...
Data, logs, and system metrics flow from devices to the Toit console:

- Devices collect data, logs, and system metrics at specified intervals or triggers. Each Toit app has a specification file which defines these settings. These are saved on the device and sent to the Toit console each time the device comes online and connects to the console.
