...
model.cellular.sara_r4 | If set to `1`, activates the UBlox Sara R4 chip in the Cellular system.
model.cellular.sara_r5 | If set to `1`, activates the UBlox Sara R5 chip in the Cellular system.
